      ...
      <div className="app-container py-10 md:py-12">
        <div className="grid gap-8 md:grid-cols-[minmax(0,1fr)_minmax(18rem,0.95fr)]">
          <div className="space-y-4">
            <Link href="/" aria-label="Acasă SkySend">
              <BrandMark />
            </Link>
            <p className="max-w-md text-sm leading-6 text-muted-foreground">
              SkySend operează o platformă de livrare cu drona pentru Pitești,
              cu acoperire clară, urmărire live și predări controlate.
            </p>
          </div>

          <div className="grid gap-8 sm:grid-cols-2">
            <div className="space-y-3">
              <p className="type-caption">Navigație</p>
              <nav aria-label="Navigație subsol" className="grid gap-2">
        ...
        <div className="mt-8 flex flex-col gap-2 border-t border-border/80 pt-5 text-sm text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
          <p>Copyright 2026 {siteConfig.name}. Livrare live cu drona în Pitești.</p>
          <p>Construit pentru operațiuni clare, trasee lizibile și predări verificate.</p>
        </div>
      </div>
    </footer>
  );
