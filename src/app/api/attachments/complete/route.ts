...
import { z } from "zod";
import { completeAttachmentUpload } from "@/lib/attachments/server";
...
export async function POST(request: Request) {
  ...
  try { return NextResponse.json({ attachment: await completeAttachmentUpload(identity, parsed.data) }); }
